      ...
      <main className="max-w-3xl w-full text-center space-y-8 relative z-10">
        ...
        <div className="max-w-lg mx-auto pt-8">
          <Button
            ...
            className="w-full px-10 rounded-lg transition-all duration-200 border-0 whitespace-nowrap flex items-center justify-center gap-3 text-white font-semibold text-lg"
            style={{
